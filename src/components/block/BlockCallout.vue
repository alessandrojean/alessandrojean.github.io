...
const colorMap: { [key in ApiColor]?: string[] } = {
  gray_background: ['bg-gray-50', 'text-gray-800'],
  orange_background: ['bg-orange-50', 'text-orange-900'],
  yellow_background: ['bg-yellow-50', 'text-yellow-900'],
  green_background: ['bg-emerald-50', 'text-emerald-900'],
  blue_background: ['bg-blue-50', 'text-blue-900'],
  purple_background: ['bg-purple-50', 'text-purple-900'],
  pink_background: ['bg-pink-50', 'text-pink-900'],
  red_background: ['bg-red-50', 'text-red-900']
}
...
<template>
  <div
    :class="[
      ...
      'flex flex-col md:flex-row p-3 rounded-lg gap-3',
      bgColor,
      textColor,
    ]"
  >
