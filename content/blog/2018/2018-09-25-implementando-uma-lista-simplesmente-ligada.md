...
description: Uma implementação simples, mas que cumpre seu papel.
language: pt-BR
...
::large-figure
![Representação de uma lista simplesmente ligada.](https://i.imgur.com/9xJ6wLs.png)
...
1. Se o nó arbitrário é nulo, então há nada a ser feito, basta retornar o nó criado.
2. Se o nó arbitrário não é nulo, basta fazer com que o nó criado aponte para o `next` deste nó arbitrário e que o nó arbitrário agora aponte para o nó criado.
...
- [Implementando uma Pilha](/post/implementando-uma-pilha)
