...
description: Uma implementação simples dando sequência a série de Estrutura de Dados.
language: pt-BR
...
::large-figure
![Representação simples em execução de uma pilha com operações de empilhar e desempilhar. Fonte: Wikipédia.](https://upload.wikimedia.org/wikipedia/commons/b/b4/Lifo_stack.png)

#caption
Representação simples em execução de uma pilha com operações de empilhar e desempilhar. Fonte: Wikipédia.
::
...
- [Implementando uma Lista Simplesmente Ligada](/post/implementando-uma-lista-simplesmente-ligada)
- *Implementando uma Pilha*
- [Implementando uma Fila](/post/implementando-uma-fila)
